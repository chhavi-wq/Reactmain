            ...
            >
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                ...
                <div className="text-left md:text-right">
                  ...
                  <p className="mt-2 text-sm text-[#8A8A8A]">Per Item</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-12 rounded-[30px] border border-[#E7E0D8] bg-[#FFFCF8] p-8 shadow-sm">
          ...
          <div className="mt-8 space-y-5">
            <div className="flex items-center justify-between">
              <span className="text-[#6B6B6B]">Total Items</span>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium text-[#32473D]">Free</span>
            </div>

            <div className="border-t border-[#E7E0D8] pt-6 flex items-center justify-between">
              <span className="text-2xl font-medium text-[#23332B]">Total</span>

              <span className="text-4xl font-semibold text-[#32473D]">
                ₹
                {cartitems.reduce(
                  (total, item) =>
                    total + Math.floor(item.price * 100) * item.quantity,
                  0,
                )}
              </span>
            </div>
