          ...
          >
            ...
            >
              ...
              <div className="gap-10 text-2xl items-center justify-center flex">
                ...
                <h1 className="font-bold">${item.price.toFixed(0)}</h1>
              </div>
                <div className="flex gap-5 text-xl items-center justify-center flex">
              ...
              <button className="bg-black rounded-3xl border border-black font-mono font-bold text-white hover:bg-white py-2 px-5 hover:text-black transition duration-300" onClick={(item)=>{
